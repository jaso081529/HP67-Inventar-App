...
const VERSIONED_ASSETS=['./v38/app.css','./v38/app.js','./v38/smart-camera.js'];
...
self.addEventListener('fetch',e=>{
  ...
  const isVersionedCore=requestUrl.origin===scopeUrl.origin&&requestUrl.pathname.startsWith(`${scopeUrl.pathname}v38/`);
  if(isVersionedCore){
