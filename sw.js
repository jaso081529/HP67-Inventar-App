...
const VERSIONED_ASSETS=['./v317/app.css','./v317/app.js','./v317/smart-camera.js'];
...
self.addEventListener('fetch',e=>{
  ...
  const isVersionedCore=requestUrl.origin===scopeUrl.origin&&requestUrl.pathname.startsWith(`${scopeUrl.pathname}v317/`);
  if(isVersionedCore){
