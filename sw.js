...
const VERSIONED_ASSETS=['./v314/app.css','./v314/app.js','./v314/smart-camera.js'];
...
self.addEventListener('fetch',e=>{
  ...
  const isVersionedCore=requestUrl.origin===scopeUrl.origin&&requestUrl.pathname.startsWith(`${scopeUrl.pathname}v314/`);
  if(isVersionedCore){
