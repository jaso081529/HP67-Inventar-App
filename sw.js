...
const VERSIONED_ASSETS=['./v312/app.css','./v312/app.js','./v312/smart-camera.js'];
...
self.addEventListener('fetch',e=>{
  ...
  const isVersionedCore=requestUrl.origin===scopeUrl.origin&&requestUrl.pathname.startsWith(`${scopeUrl.pathname}v312/`);
  if(isVersionedCore){
