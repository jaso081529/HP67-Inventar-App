...
const VERSIONED_ASSETS=['./v319/app.css','./v319/app.js','./v319/smart-camera.js'];
...
self.addEventListener('fetch',e=>{
  ...
  const isVersionedCore=requestUrl.origin===scopeUrl.origin&&requestUrl.pathname.startsWith(`${scopeUrl.pathname}v319/`);
  if(isVersionedCore){
