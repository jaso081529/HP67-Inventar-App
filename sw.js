...
const VERSIONED_ASSETS=['./v315/app.css','./v315/app.js','./v315/smart-camera.js'];
...
self.addEventListener('fetch',e=>{
  ...
  const isVersionedCore=requestUrl.origin===scopeUrl.origin&&requestUrl.pathname.startsWith(`${scopeUrl.pathname}v315/`);
  if(isVersionedCore){
