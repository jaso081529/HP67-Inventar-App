...
const VERSIONED_ASSETS=['./v36/app.css','./v36/app.js','./v36/smart-camera.js'];
...
self.addEventListener('fetch',e=>{
  ...
  const isVersionedCore=requestUrl.origin===scopeUrl.origin&&requestUrl.pathname.startsWith(`${scopeUrl.pathname}v36/`);
  if(isVersionedCore){
