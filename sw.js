...
const VERSIONED_ASSETS=['./v39/app.css','./v39/app.js','./v39/smart-camera.js'];
...
self.addEventListener('fetch',e=>{
  ...
  const isVersionedCore=requestUrl.origin===scopeUrl.origin&&requestUrl.pathname.startsWith(`${scopeUrl.pathname}v39/`);
  if(isVersionedCore){
