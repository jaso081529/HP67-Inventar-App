...
const VERSIONED_ASSETS=['./v34/app.css','./v34/app.js','./v34/smart-camera.js'];
...
self.addEventListener('fetch',e=>{
  ...
  const requestUrl=new URL(e.request.url),scopeUrl=new URL(self.registration.scope),isVersionedCore=requestUrl.origin===scopeUrl.origin&&requestUrl.pathname.startsWith(`${scopeUrl.pathname}v34/`);
  if(isVersionedCore){
